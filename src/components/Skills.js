...
export const Skills = () => {
  ...
  const skillsData = [
    ...
    },
    {
      ...
      category: "big-data",
      level: 80,
      // Card index dividers icon
      color: "#E74C3C",
      description: "Matplotlib, Seaborn, Power BI, Metabase, Tableau, Apache Spark Streaming, HBase"
        },
        {
  id: 8,
  title: "Data Analyst",
  ...
  icon: "📈",
  color: "#F39C7F",
  description: "Excel, SQL, Tableau, Power BI, Python (Pandas), visualisation de données"
},
{
  id: 9,
  title: "Soft Skills",
                          ...
                          {({ isVisible }) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {/* Niveau retiré : suppression de la barre de pourcentage */}
                              </div>
                            );
                          }}
                        </TrackVisibility>
